...
//   templateUrl: 'build/pages/products/product-list.html'
})
export class ProductListComponent {
    ...
    constructor(public nav: NavController, 
        ...
        console.log("ProductListComponent (product-list.ts):");
    ...
    itemTapped($event, product){
        ...
        this.nav.push(ProductDetailComponent, product);   
    }


    private fillProductArray () {
       console.log("fillProductArray called!");
    ...
    } //end of fillProductArray function
